						...
						<tr>
							<td>
								...
								<p style="text-align: center">
									<a href="listado.do?opt=0&amp;idpr=<bean:write name="producto" property="id"/>&amp;refpr=<bean:write name="producto" property="referencia"/>"><bean:message key="app.listado.0"/></a> | <a href="listado.do?opt=1&amp;idpr=<bean:write name="producto" property="id"/>&amp;refpr=<bean:write name="producto" property="referencia"/>&amp;idcat=<bean:write name="idcat"/>"><bean:message key="app.listado.1"/></a>
								</p>
