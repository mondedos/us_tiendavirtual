...
INSERT INTO `producto` (`ID_ITEM_3`,`VC_MARCA`,`VC_MODELO`,`VC_DIMENSIONES`,`MO_PRECIO`,`IN_GANANCIA`,`VC_DESCRIPCION`,`VC_FOTO`) VALUES 
 ...
 (4,'Zanussi','ZNB 34 NDX','Alto 185 cm - Ancho 60 cm',456.00,10,'Figrorifico con ventilador interno para distribuir el frio, puerta de acero inoxidable y bandejas de cristal.','Frigorifico/Zanussi_ZNB_34_NDX.jpg'),
 (5,'Bosch','KGU 34175 EU','Alto 186 cm - Ancho 60 cm',465.00,6,'Frigorifico con dos motores, de acero inoxidable y bandejas de cristal.','Frigorifico/Bosch_KGU_34175_EU.jpg'),
 (6,'Bosch','KGU 44170 eu','Alto 201cm - Ancho 70cm',1081.58,25,'Frigorifico de acero inoxidable con dos motores y controles frigorifico-congelador separados.','Frigorifico/Bosch_KGU_44170_EU');
INSERT INTO `producto` (`ID_ITEM_3`,`VC_MARCA`,`VC_MODELO`,`VC_DIMENSIONES`,`MO_PRECIO`,`IN_GANANCIA`,`VC_DESCRIPCION`,`VC_FOTO`) VALUES 
 ...
 (12,'Fagor','F2812','Alto 85 cm - Ancho 59 cm',499.00,10,'Lavadora con cuba de acero inosidable y con 8 kg de carga.','Lavadora/Fagor_F_2812.jpg');
INSERT INTO `producto` (`ID_ITEM_3`,`VC_MARCA`,`VC_MODELO`,`VC_DIMENSIONES`,`MO_PRECIO`,`IN_GANANCIA`,`VC_DESCRIPCION`,`VC_FOTO`) VALUES 
 ...
 (14,'Whirlpool','AWM-7106','Alto 85 cm - Ancho 60 cm',320.75,20,'Lavadora con cuba de plÃ¡stico de 5 kg de capacidad y carga frontal.','Lavadora/Whirlpool_AWM_7106.jpg'),
 (15,'Panasonic','DVD-LS91','Altura 2.03 in-Ancho 9.28 in-Profundidad 7.28',194.99,12,'Esta impresionante pantalla de 9\" en este reproductor de DVD portÃ¡til es ideal para pelÃ­culas en el asiento trasero durante un viaje largo. La entrada dual para audÃ­fonos permite que dos personas oigan simultÃ¡neamente.','Dvd/Panasonic DVD-LS91.jpg'),
 (16,'Philips','HR-2094','Altura 20 cm',86.20,30,'PequeÃ±a batidora','PequenosElectrodomesticos/Philips_HR_2094__550219.jpg'),
 (21,'Taurus','BAPI 600 IX','TamaÃ±o 18 cm ',28.59,21,'PequeÃ±a batidora.','PequenosElectrodomesticos/Taurus_BAPI_600_IX.jpg'),
...
INSERT INTO `producto` (`ID_ITEM_3`,`VC_MARCA`,`VC_MODELO`,`VC_DIMENSIONES`,`MO_PRECIO`,`IN_GANANCIA`,`VC_DESCRIPCION`,`VC_FOTO`) VALUES 
 ...
 (25,'Kenwood','JE 700','Altura 24 cm',228.00,10,'Licuadora','PequenosElectrodomesticos/Kenwood_JE_700.jpg'),
 (26,'Samsung','DVD-VR357','Altura 3 cm - Anchura 32 cm',174.54,4,'Esta versÃ¡til unidad reproduce tanto discos DVD con casetes VHS, entregando imÃ¡genes claras y con una calidad de sonido alta. El Samsung DVD-VR357 incluye una video casetera de 4 cabezas Hi-Fi con la claridad visual de una salida Progressive scan.','Dvd/DVDVR375.jpg'),
 (27,'Samsung','DVD-HD870','Altura 3 cm- Anchura 28 cm',185.90,6,'El reproductor de DVD de Samsung mejora la seÃ±al (1080i/720P) con una salida HDMI, 14 bit DAC y reproducciÃ³n de WMA/MP3.','Dvd/DVD-HD870.jpg'),
 (28,'Coby','DVD-224','Altura 3 cm - Anchura 31 cm',45.60,9,'Supera tu sistema home theater con el reproductor de alto desempeÃ±o de Coby DVD-224 DVD. Con un diseÃ±o delgado, contiene la tecnologÃ­a Progressive Scan para la mejor imagen posible. Reproduce tus formatos de discos favoritos incluyendo MP3 para una versatilidad Ã³ptima. El acabado plateado hace que complemente cualquier decoraciÃ³n fÃ¡cilmente.','Dvd/DVD224.jpg');
INSERT INTO `producto` (`ID_ITEM_3`,`VC_MARCA`,`VC_MODELO`,`VC_DIMENSIONES`,`MO_PRECIO`,`IN_GANANCIA`,`VC_DESCRIPCION`,`VC_FOTO`) VALUES 
 (29,'Denon','DVD-3930CI','Altura 4 cm - Anchura 33 cm',156.87,7,'Denon\'s rock-solid DVD-3930CI produces a vivid picture that\'s faithful in every detail. It sports extremely advanced video and audio processing, including the professional-grade Realta HQV chip from Silicon Optix Ã¢â‚¬â€ formerly available from Denon only in their top-of-the-line DVD-5910CI. This powerful chip reduces noise on a pixel-by-pixel basis and upconverts standard DVD signals to 1080p resolution for an unforgettable movie experience with compatible HDTVs. Regardless of whether the original source was film or video, you\'ll enjoy a remarkably crisp and colorful picture, free from blurriness, \"jaggies,\" and other digital artifacts.','Dvd/DVD3930ci.jpg'),
 (30,'Lynx','4FE-23 	 ','Alto: 155 cm - Ancho: 55 cm',319.00,5,'Frigorifico con un solo motor y bandejas de cristal.','Frigorifico/Lynx_4FE_23.jpg');
