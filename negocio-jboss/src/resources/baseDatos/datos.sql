...
INSERT INTO `dvd` (`ID_ITEM_3`,`VC_FORMATO`,`VC_CONECTORES_IO`) VALUES 
 ...
 (29,'Audio CD,\r\nCD-R,\r\nCD-RW,\r\nDVD,\r\nDVD Audio,\r\nDVD+R,\r\nDVD+RW,\r\nDVD-R,\r\nDVD-RW,\r\nSACD,\r\nVideo CD (VCD)','Entrada: Serial RS-232C - 9 .\r\nSalida de Audio: 5.1 Channel RCA, Digital Coaxial, Digital Optical y Composite (RCA).\r\nSalida de Video: BNC Component Video, Component Video, Composite (RCA), HDMI y S-Video.');
...
INSERT INTO `pequeno_electrodomestico` (`ID_ITEM_3`,`VC_CARACTERISTICAS`) VALUES 
 (16,'Batidora con vaso de plástico y de velocidad variable. Carece de accesorios para la minipicadora.'),
 (21,'Batidora con pie de metal, con envases para batir de diferentes tamaños.'),
 (22,'Tostadora con bandeja recogemigas, con botón de parada y sistema calientabollos integrado.'),
 (23,'Tostadora con doble ranura, con botón de parada y sin calientabollos.'),
...
INSERT INTO `linea_pedido` (`ID_LINEA`, `ID_ITEM`, `ID_PEDIDO`, `MO_PRECIO_UNIDAD`, `IN_UNIDADES`) VALUES
 (1, 1, 3, 100, 1),
 (2, 2, 3, 200, 2),
 (3, 3, 4, 100, 1);